...
set RTI_RID_FILE=gatewayRTI.rid

java.exe -Ddevstudio.generatedcode.settings=FederateConfig.txt -Djava.net.preferIPv4Stack=true -cp %RTI_LIB%/portico.jar;lib/*;TestTool.jar com.ivir.mms.testtool.TestTool
